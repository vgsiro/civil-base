...
function Table41() {
  ...
  const rows = useMemo(() => [
    { cat: '0',   desc: t('std_ec1_t4_1_cat0'), z0: '0,003', zmin: '1' },
    { cat: 'I',   desc: t('std_ec1_t4_1_cat1'), z0: '0,01',  zmin: '1' },
    { cat: 'II',  desc: t('std_ec1_t4_1_cat2'), z0: '0,05',  zmin: '2' },
    { cat: 'III', desc: t('std_ec1_t4_1_cat3'), z0: '0,3',   zmin: '5' },
    { cat: 'IV',  desc: t('std_ec1_t4_1_cat4'), z0: '1,0',   zmin: '10' },
  ], [t])
  return (
    <TableBlock id="t4-1" title={t('std_ec1_t4_1_title')}
      notes={t('std_ec1_t4_1_note')}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'center', width: 40 }}>{t('std_ec1_t4_1_col_cat')}</th>
          <th style={{ ...THS, textAlign: 'left', minWidth: 340 }}>{t('std_ec1_t4_1_col_terrain')}</th>
          <th style={{ ...THS }}>z₀ (m)</th>
...
function Table51() {
  ...
  const groups = useMemo(() => [
    {
      header: t('std_ec1_t5_1_g1'),
      rows: [
        { param: t('std_ec1_t5_1_p_vb'),      ref: '4.2 (2)P' },
        { param: t('std_ec1_t5_1_p_ze'),       ref: 'Section 7' },
        { param: t('std_ec1_t5_1_p_terrain'),  ref: 'Table 4.1' },
        { param: t('std_ec1_t5_1_p_qp'),       ref: '4.5 (1)' },
        { param: t('std_ec1_t5_1_p_iv'),       ref: '4.4' },
        { param: t('std_ec1_t5_1_p_vm'),       ref: '4.3.1' },
        { param: t('std_ec1_t5_1_p_co'),       ref: '4.3.3' },
        { param: t('std_ec1_t5_1_p_cr'),       ref: '4.3.2' },
      ],
    },
    {
      header: t('std_ec1_t5_1_g2'),
      rows: [
        { param: t('std_ec1_t5_1_p_cpe'),    ref: 'Section 7' },
        { param: t('std_ec1_t5_1_p_cpi'),    ref: 'Section 7' },
        { param: t('std_ec1_t5_1_p_cpnet'),  ref: 'Section 7' },
        { param: t('std_ec1_t5_1_p_we'),     ref: '5.2 (1)' },
        { param: t('std_ec1_t5_1_p_wi'),     ref: '5.2 (2)' },
      ],
    },
    {
      header: t('std_ec1_t5_1_g3'),
      rows: [
        { param: t('std_ec1_t5_1_p_cscd'),      ref: '6' },
        { param: t('std_ec1_t5_1_p_fw_force'),  ref: '5.3 (2)' },
        { param: t('std_ec1_t5_1_p_fw_press'),  ref: '5.3 (3)' },
      ],
    },
  ], [t])
  return (
    <TableBlock id="t5-1" title={t('std_ec1_t5_1_title')}>
      <Table>
        <thead><tr>
  ...
  return (
    <TableBlock id="t7-1"
      ...
      <Table>
        <thead>
          <tr>
            <th style={{ ...THS, textAlign: 'left' }} rowSpan={2}>{t('std_ec1_col_zone')}</th>
...
function Table72() {
  ...
  return (
    <TableBlock id="t7-2" title={t('std_ec1_t7_2_title')}
      notes={<>
      ...
      <Table>
        <thead>
          <tr>
            <th style={{ ...THS, textAlign: 'left' }} rowSpan={2}>{t('std_ec1_col_roof_type')}</th>
...
function Table73a() {
  ...
  return (
    <TableBlock id="t7-3a" title={t('std_ec1_t7_3a_title')}
      notes={<>
      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        <div>
          ...
          <Table>
            <thead>
              <tr>
                <th style={{ ...THS, textAlign: 'left' }} rowSpan={2}>{t('std_ec1_col_pitch_angle')}</th>
...
function Table73b() {
  ...
  return (
    <TableBlock id="t7-3b" title={t('std_ec1_t7_3b_title')}
      notes={<>
...
function Table74a() {
  ...
  return (
    <TableBlock id="t7-4a" title={t('std_ec1_t7_4a_title')}
      notes={<>
...
function Table74b() {
  ...
  return (
    <TableBlock id="t7-4b" title={t('std_ec1_t7_4b_title')}>
      <div style={SUB}>Zone for wind direction θ = 90°</div>
      <Table>
        <thead>
          <tr>
...
function Table75() {
  ...
  return (
    <TableBlock id="t7-5" title={t('std_ec1_t7_5_title')}
      notes={<>
...
function Table76() {
  ...
  return (
    <TableBlock id="t7-6" title={t('std_ec1_t7_6_title')}
      notes={<>
        <div>{t('std_ec1_t7_6_note1')}</div>
        <div>{t('std_ec1_t7_6_note2')}</div>
      </>}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_roof_angle')}</th>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_blockage')}</th>
          <th style={THS}>{t('std_ec1_col_overall_cf')}</th>
...
function Table77() {
  ...
  return (
    <TableBlock id="t7-7" title={t('std_ec1_t7_7_title')}
      notes={<>
        <div>{t('std_ec1_t7_6_note1')}</div>
        <div>{t('std_ec1_t7_6_note2')}</div>
      </>}>
...
function Table78() {
  const { t } = useTranslation()
  const rows = useMemo(() => [
    { bay: '1', loc: t('std_ec1_t7_8_bay1'), down: '1,0', up: '0,8' },
    { bay: '2', loc: t('std_ec1_t7_8_bay2'), down: '0,9', up: '0,7' },
    { bay: '3', loc: t('std_ec1_t7_8_bay3'), down: '0,7', up: '0,7' },
  ], [t])
  return (
    <TableBlock id="t7-8" title={t('std_ec1_t7_8_title')}>
      <Table>
        <thead>
          <tr>
            <th style={{ ...THS, textAlign: 'left' }} rowSpan={2}>{t('std_ec1_col_bay')}</th>
            <th style={{ ...THS, textAlign: 'left' }} rowSpan={2}>{t('std_ec1_col_location')}</th>
            <th style={THS} colSpan={2}>ψ<sub>mc</sub> factors for all φ</th>
          </tr>
          <tr>
            <th style={{ ...THS, minWidth: 160 }}>{t('std_ec1_t7_8_col_down')}</th>
            <th style={{ ...THS, minWidth: 160 }}>{t('std_ec1_t7_8_col_up')}</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((r, i) => (
...
function Table79() {
  const { t } = useTranslation()
  return (
    <TableBlock id="t7-9" title={t('std_ec1_t7_9_title')}
      notes={<>
        <div><sup>a</sup>  Linear interpolation may be used for return corner lengths between 0,0 and h</div>
      </>}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_solidity')}</th>
...
function Table710() {
  const { t } = useTranslation()
  const rows = useMemo(() => [
    { surface: t('std_ec1_t7_10_smooth'),    cfr: '0,01' },
    { surface: t('std_ec1_t7_10_rough'),     cfr: '0,02' },
    { surface: t('std_ec1_t7_10_very_rough'),cfr: '0,04' },
  ], [t])
  return (
    <TableBlock id="t7-10" title={t('std_ec1_t7_10_title')}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left', minWidth: 280 }}>{t('std_ec1_col_surface')}</th>
          <th style={THS}>{t('std_ec1_col_friction_cfr')}</th>
        </tr></thead>
        <tbody>
          {rows.map((r, i) => (
...
function Table711() {
  ...
  return (
    <TableBlock id="t7-11" title={t('std_ec1_t7_11_title')}
      notes={<>
      ...
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_no_sides')}</th>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_sections')}</th>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_finish')}</th>
          <th style={{ ...THS, textAlign: 'left' }}>{t('std_ec1_col_reynolds')}</th>
...
function Table713() {
  ...
  return (
    <TableBlock id="t7-13" title={t('std_ec1_t7_13_title')}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left', minWidth: 140 }}>{t('std_ec1_col_type_surface')}</th>
...
function Table714() {
  const { t } = useTranslation()
  return (
    <TableBlock id="t7-14" title={t('std_ec1_t7_14_title')}
      notes={<>
...
function Table715() {
  const { t } = useTranslation()
  return (
    <TableBlock id="t7-15" title={t('std_ec1_t7_15_title')}
...
function Table716() {
  ...
  return (
    <TableBlock id="t7-16"
      title={t('std_ec1_t7_16_title')}
      notes="For intermediate values of ℓ, linear interpolation should be used.">
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left', width: 50 }}>No.</th>
          <th style={{ ...THS, textAlign: 'left', minWidth: 200 }}>{t('std_ec1_col_position')}</th>
          <th style={{ ...THS, textAlign: 'left', minWidth: 280 }}>{t('std_ec1_col_eff_lambda')}</th>
        </tr></thead>
        <tbody>
          <TR stripe={false}>
...
function Table81() {
  const { t } = useTranslation()
  const rows = useMemo(() => [
    { system: t('std_ec1_t8_1_open_parapet'), one: 'd + 0,3 m', both: 'd + 0,6 m' },
    { system: t('std_ec1_t8_1_solid_parapet'), one: 'd + d₁',    both: 'd + 2d₁'  },
    { system: t('std_ec1_t8_1_open_both'),     one: 'd + 0,6 m', both: 'd + 1,2 m' },
  ], [t])
  return (
    <TableBlock id="t8-1" title={t('std_ec1_t8_1_title')}>
      <Table>
        <thead><tr>
          <th style={{ ...THS, textAlign: 'left', minWidth: 240 }}>{t('std_ec1_col_road_system')}</th>
          <th style={THS}>{t('std_ec1_col_one_side')}</th>
          <th style={THS}>{t('std_ec1_col_both_sides')}</th>
        </tr></thead>
        <tbody>
          {rows.map((r, i) => (
...
function Table82() {
  const { t } = useTranslation()
  return (
    <TableBlock id="t8-2" title={t('std_ec1_t8_2_title')}
      notes={<>
...
// ─── Search + index ─── (moved inside WindTables component as useMemo)
...
export default function WindTables() {
  ...
  const ALL_TABLES = useMemo(() => [
    { id: 't4-1',  label: 'Table 4.1',  title: t('std_ec1_all_t4_1'),  section: 'Chapter 4' },
    { id: 't5-1',  label: 'Table 5.1',  title: t('std_ec1_all_t5_1'),  section: 'Chapter 5' },
    { id: 't7-1',  label: 'Table 7.1',  title: t('std_ec1_all_t7_1'),  section: 'Section 7' },
    { id: 't7-2',  label: 'Table 7.2',  title: t('std_ec1_all_t7_2'),  section: 'Section 7' },
    { id: 't7-3a', label: 'Table 7.3a', title: t('std_ec1_all_t7_3a'), section: 'Section 7' },
    { id: 't7-3b', label: 'Table 7.3b', title: t('std_ec1_all_t7_3b'), section: 'Section 7' },
    { id: 't7-4a', label: 'Table 7.4a', title: t('std_ec1_all_t7_4a'), section: 'Section 7' },
    { id: 't7-4b', label: 'Table 7.4b', title: t('std_ec1_all_t7_4b'), section: 'Section 7' },
    { id: 't7-5',  label: 'Table 7.5',  title: t('std_ec1_all_t7_5'),  section: 'Section 7' },
    { id: 't7-6',  label: 'Table 7.6',  title: t('std_ec1_all_t7_6'),  section: 'Section 7' },
    { id: 't7-7',  label: 'Table 7.7',  title: t('std_ec1_all_t7_7'),  section: 'Section 7' },
    { id: 't7-8',  label: 'Table 7.8',  title: t('std_ec1_all_t7_8'),  section: 'Section 7' },
    { id: 't7-9',  label: 'Table 7.9',  title: t('std_ec1_all_t7_9'),  section: 'Section 7' },
    { id: 't7-10', label: 'Table 7.10', title: t('std_ec1_all_t7_10'), section: 'Section 7' },
    { id: 't7-11', label: 'Table 7.11', title: t('std_ec1_all_t7_11'), section: 'Section 7' },
    { id: 't7-12', label: 'Table 7.12', title: t('std_ec1_all_t7_12'), section: 'Section 7' },
    { id: 't7-13', label: 'Table 7.13', title: t('std_ec1_all_t7_13'), section: 'Section 7' },
    { id: 't7-14', label: 'Table 7.14', title: t('std_ec1_all_t7_14'), section: 'Section 7' },
    { id: 't7-15', label: 'Table 7.15', title: t('std_ec1_all_t7_15'), section: 'Section 7' },
    { id: 't7-16', label: 'Table 7.16', title: t('std_ec1_all_t7_16'), section: 'Section 7' },
    { id: 't8-1',  label: 'Table 8.1',  title: t('std_ec1_all_t8_1'),  section: 'Chapter 8' },
    { id: 't8-2',  label: 'Table 8.2',  title: t('std_ec1_all_t8_2'),  section: 'Chapter 8' },
  ], [t])

  const GROUPED = useMemo(() => [
    { section: 'Chapter 4', label: t('std_ec1_wind_tbl_ch4') },
    { section: 'Chapter 5', label: t('std_ec1_wind_tbl_ch5') },
    { section: 'Section 7', label: t('std_ec1_wind_tbl_sec7') },
    { section: 'Chapter 8', label: t('std_ec1_wind_tbl_ch8') },
  ], [t])
            ...
            <>
              ...
              <div style={{ padding: '12px 12px 10px', flexShrink: 0, background: '#fafafa', borderBottom: '1px solid #e2e8f0' }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: '#1e293b', marginBottom: 7, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {t('std_ec1_wind_tbl_header')}
                </div>
                <input
                  value={query}
                  onChange={e => { setQuery(e.target.value); setActive(null) }}
                  placeholder={t('std_ec1_wind_tbl_search')}
              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                {q
                  ? (
                    <div>
                      {filtered.length === 0 && (
                        <div style={{ padding: '8px 14px', fontSize: 12, color: '#1e293b' }}>{t('std_ec1_wind_tbl_no_results')}</div>
                      )}
                      {filtered.map(t => (
        ...
        {ActiveComp
          ...
          : (
            <div style={{ color: '#1e293b', fontSize: 13, marginTop: 40, textAlign: 'center' }}>
              ...
              <div>{t('std_ec1_wind_tbl_select_hint')}</div>
