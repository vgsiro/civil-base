  ...
  return (
    <>
      <p style={{ fontSize: 11, color: '#1e293b', marginBottom: 10 }}>
        <strong>{t('std_ec2rc_det_according_to')}</strong> EN 1992-1-1:2004+AC:2008 §6.1, §3.1.7, §3.2.7
      </p>

      <DetailGroup title={t('std_ec2rc_det_input_data')}>
        <InputDataTable>
          <InputDataRow param={t('std_ec2rc_uld_in_fck')} symbol={<Tex>{'f_{ck}'}</Tex>} value={n(fck, 2)} unit="MPa" />
          <InputDataRow param={t('std_ec2rc_uld_in_fyk')} symbol={<Tex>{'f_{yk}'}</Tex>} value={n(fyk, 2)} unit="MPa" />
          <InputDataRow param={t('std_ec2rc_uld_in_sslaw')} symbol="" value={t('std_ec2rc_uld_in_sslaw_val')} />
          <InputDataRow param={t('std_ec2rc_uld_in_ratio')} symbol={<Tex>{'(f_t/f_y)_k'}</Tex>} value="1" />
          <InputDataRow param={t('std_ec2rc_uld_in_euk')} symbol={<Tex>{'\\varepsilon_{uk}'}</Tex>} value="75.00" unit="‰" />
          <InputDataRow param={t('std_ec2rc_uld_in_h')} symbol={<Tex>{'h'}</Tex>} value={n(h, 3)} unit="m" />
          <InputDataRow param={t('std_ec2rc_uld_in_b')} symbol={<Tex>{'b'}</Tex>} value={n(b, 3)} unit="m" />
          <InputDataRow param={t('std_ec2rc_uld_in_l1')} symbol={<Tex>{'n_1,\\,\\Phi_1'}</Tex>} value={rows1.map((r, i) => `${t('std_ec2rc_uld_row_label')} ${i + 1}: ${r.n}×Φ${r.phi}`).join(', ')} unit="mm" />
          <InputDataRow param={t('std_ec2rc_uld_in_c1')} symbol={<Tex>{"c'_1"}</Tex>} value={n(c1, 3)} unit="m" />
          <InputDataRow param={t('std_ec2rc_uld_in_l2')} symbol={<Tex>{'n_2,\\,\\Phi_2'}</Tex>} value={rows2.map((r, i) => `${t('std_ec2rc_uld_row_label')} ${i + 1}: ${r.n}×Φ${r.phi}`).join(', ')} unit="mm" />
          <InputDataRow param={t('std_ec2rc_uld_in_c2')} symbol={<Tex>{"c'_2"}</Tex>} value={n(c2, 3)} unit="m" />
          <InputDataRow param={t('std_ec2rc_uld_in_l3')} symbol={<Tex>{'n_3,\\,\\Phi_3'}</Tex>} value={`${nbars3} × Φ${phi3}`} unit="mm" />
          <InputDataRow param={t('std_ec2rc_uld_in_med')} symbol={<Tex>{'M_{Ed}'}</Tex>} value={n(MEd, 0)} unit="kNm" />
          <InputDataRow param={t('std_ec2rc_uld_in_ned')} symbol={<Tex>{'N_{Ed}'}</Tex>} value={n(NEd, 0)} unit="kN" />
        </InputDataTable>
        <p style={{ ...PROSE, marginTop: 6 }}>
          <strong>{t('std_ec2rc_uld_ndp')}</strong> &nbsp;
          α<sub>cc</sub> = {n(acc)}, &nbsp; γ<sub>c</sub> = {n(gc)}, &nbsp; γ<sub>s</sub> = {n(gs)}
        </p>
      </DetailGroup>

      <DetailGroup title={t('std_ec2rc_uld_props')}>
        <CalcStep label={t('std_ec2rc_uld_area_gross')}
          formula={`A = b \\cdot h = ${n(b,4)}\\ \\mathrm{m} \\times ${n(h,4)}\\ \\mathrm{m} = ${n(A,4)}\\ \\mathrm{m^2}`}
          result={<Tex>{`A = ${n(A,4)}\\ \\mathrm{m^2}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_second_moment_gross')}
          formula={`I = \\dfrac{b \\cdot h^3}{12} = \\dfrac{${n(b,4)} \\cdot ${n(h,4)}^3}{12} = ${n(I,6)}\\ \\mathrm{m^4}`}
          result={<Tex>{`I = ${n(I,6)}\\ \\mathrm{m^4}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_centroid')}
          formula={`z_{cm} = h/2 = ${n(zcm,4)}\\ \\mathrm{m}`}
          result={<Tex>{`z_{cm} = ${n(zcm,4)}\\ \\mathrm{m}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_reinf_areas')}
        ...
        <CalcStep label={t('std_ec2rc_uld_total_reinf')}
        ...
        <CalcStep label={t('std_ec2rc_uld_tens_axial')}
      ...
      <DetailGroup title={t('std_ec2rc_uld_ss_concrete')}>
        <p style={PROSE}><Sub>{t('std_ec2rc_uld_parabolic')}</Sub></p>
        <CalcStep label={t('std_ec2rc_uld_fcd')}
        ...
        <CalcStep label={<>{t('std_ec2rc_uld_strain_params_pre')} f<sub>ck</sub> = {n(fck, 0)} MPa</>}
          formula={`\\varepsilon_{c2} = ${n(ec2v,2)}\\ ‰,\\quad \\varepsilon_{cu2} = ${n(ecu2,2)}\\ ‰,\\quad n = ${n(nv,2)}`}
          result={<Tex>{`\\varepsilon_{cu2} = ${n(ecu2,2)}\\ ‰`}</Tex>}
          note={t('std_ec2rc_uld_strain_params_note')} />
      </DetailGroup>

      <DetailGroup title={t('std_ec2rc_uld_ss_steel')}>
        <CalcStep label={t('std_ec2rc_uld_fyd')}
        ...
        <CalcStep label={t('std_ec2rc_uld_eyd')}
      ...
      <DetailGroup title={t('std_ec2rc_uld_strain_range')}>
        <p style={PROSE}><Sub>{t('std_ec2rc_uld_strips')}</Sub></p>
        <CalcStep label={t('std_ec2rc_uld_comp_depth')}
        ...
        <CalcStep label={t('std_ec2rc_uld_rel_na')}
          formula={`x/d = ${n(x,4)}\\ \\mathrm{m} \\;/\\; ${n(d_eff,4)}\\ \\mathrm{m} = ${n(xd,4)}`}
          result={<Tex>{`x/d = ${n(xd,4)}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_curvature')}
      ...
      <DetailGroup title={t('std_ec2rc_uld_resistance')}>
        <p style={PROSE}><Sub>{t('std_ec2rc_uld_equilibrium_pre')}</Sub> N<sub>Ed</sub> = {n(NEd, 0)} kN <Sub>{t('std_ec2rc_uld_equilibrium_post')}</Sub></p>
        <CalcStep label={t('std_ec2rc_uld_gov_strain')}
          formula={`\\varepsilon_{c,top} = ${n(eps_c_top,2)}\\ ‰,\\quad \\varepsilon_{c,bot} = ${n(eps_c_bot,2)}\\ ‰`} />
        <CalcStep label={t('std_ec2rc_uld_max_conc_stress')}
          formula={`\\sigma_{c,max} = ${n(sigma_c_max,2)}\\ \\mathrm{MPa}`} />
        <CalcStep label={t('std_ec2rc_uld_reinf_ss')}
      ...
      <DetailGroup title={t('std_ec2rc_uld_internal_forces')}>
        <CalcStep label={t('std_ec2rc_uld_comp_resultant')}
          formula={`F_C = ${n(FC,2)}\\ \\mathrm{kN} \\quad \\text{at } M_C = ${n(MC,2)}\\ \\mathrm{kNm}`}
          result={<Tex>{`F_C = ${n(FC,2)}\\ \\mathrm{kN}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_tens_resultant')}
          formula={`F_T = ${n(FT,2)}\\ \\mathrm{kN} \\quad \\text{at } M_T = ${n(MT,2)}\\ \\mathrm{kNm}`}
          result={<Tex>{`F_T = ${n(FT,2)}\\ \\mathrm{kN}`}</Tex>} />
        <CalcStep label={t('std_ec2rc_uld_lever_arm')}
          formula={`z = z_T - z_C = ${n(lever,4)}\\ \\mathrm{m}`}
          result={<Tex>{`z = ${n(lever,4)}\\ \\mathrm{m}`}</Tex>} />
      </DetailGroup>

      <DetailGroup title={t('std_ec2rc_uld_min_ecc')}>
        <CalcStep label={t('std_ec2rc_uld_min_ecc_label')}
          formulaNode={<span style={{ fontStyle: 'italic' }}>e<sub>0</sub> = max(h/30, 20 mm) = max({n(h*1000/30,1)}, 20) = {n(e0*1000,1)} mm</span>}
          note={<><strong>|M<sub>Ed</sub>| = {n(Math.abs(MEd),1)} kNm {Math.abs(MEd) >= e0*Math.abs(NEd) ? '≥' : '<'} e₀·|N<sub>Ed</sub>| = {n(e0*Math.abs(NEd),1)} kNm → {Math.abs(MEd) >= e0*Math.abs(NEd) ? t('std_ec2rc_uld_ecc_satisfied') : t('std_ec2rc_uld_ecc_controls')}</strong></>} />
      </DetailGroup>

      <DetailGroup title={t('std_ec2rc_uld_moment_res')}>
        <CalcStep label={`${t('std_ec2rc_uld_moment_for')} NEd = ${n(NEd,0)} kN`}
      ...
      <DetailGroup title={t('std_ec2rc_uld_eff_stiff')}>
        <CalcStep label={t('std_ec2rc_uld_gross_stiff')}
        ...
        <CalcStep label={t('std_ec2rc_uld_eff_stiff_label')}
          ...
          note={`(EI)eff / (EI)gross = ${n(EI_eff / EI_gross, 4)} — ${t('std_ec2rc_uld_cracked_ratio_note')}`} />
      </DetailGroup>

      {inp.firstOrder && (
        <DetailGroup title={t('std_ec2rc_uld_first_order')}>
          <CalcStep label={t('std_ec2rc_uld_min_ecc_label')}
            formulaNode={<span style={{ fontStyle: 'italic' }}>e<sub>0,min</sub> = max(h/30, 20 mm) = max({n(h*1000/30,1)}, 20) = {n(e0_min*1000,1)} mm</span>} />
          {inp.useMinEcc && <>
            <CalcStep label={t('std_ec2rc_uld_end1_ecc')}
            ...
            <CalcStep label={t('std_ec2rc_uld_end2_ecc')}
            ...
            <CalcStep label={t('std_ec2rc_uld_gov_first_order')}
            ...
            {M_e0 > 0 && <CalcStep label={t('std_ec2rc_uld_first_order_moment')}
          ...
          {M1 > 0 && <CalcStep label={t('std_ec2rc_uld_total_first_order')}
      ...
      {inp.secondOrder && (
        <DetailGroup title={t('std_ec2rc_uld_second_order')}>
          <CalcStep label={t('std_ec2rc_uld_radius_gyr')}
            formula={`i = \\sqrt{I/A} = \\sqrt{${n(I,6)}/${n(A,4)}} = ${n(Math.sqrt(I/A),4)}\\ \\mathrm{m}`}
            result={<Tex>{`i = ${n(Math.sqrt(I/A),4)}\\ \\mathrm{m}`}</Tex>} />
          <CalcStep label={t('std_ec2rc_uld_slenderness')}
            formula={`\\lambda = l_0/i = ${n(inp.l0??10,3)}/${n(Math.sqrt(I/A),4)} = ${n(lambda,1)}`}
            result={<Tex>{`\\lambda = ${n(lambda,1)}`}</Tex>} />
          <CalcStep label={t('std_ec2rc_uld_rel_axial')}
            formula={`n = \\dfrac{|N_{Ed}|}{A \\cdot f_{cd}} = \\dfrac{${n(Math.abs(NEd),0)}}{${n(A*1e6,0)} \\times ${n(fcd,2)}/1000} = ${n(nu,3)}`}
            result={<Tex>{`n = ${n(nu,3)}`}</Tex>} />
          <CalcStep label={t('std_ec2rc_uld_lim_slender')}
            formula={`\\lambda_{lim} = \\dfrac{20 \\cdot A \\cdot B \\cdot C}{\\sqrt{n}} = ${n(lambda_lim,1)}`}
            result={<Tex>{`\\lambda_{lim} = ${n(lambda_lim,1)}`}</Tex>}
            note={slender ? <><strong>λ = {n(lambda,1)} &gt; λ_lim = {n(lambda_lim,1)} → {t('std_ec2rc_uld_slender_note')}</strong></> : <><strong>λ = {n(lambda,1)} ≤ λ_lim = {n(lambda_lim,1)} → {t('std_ec2rc_uld_negligible_note')}</strong></>} />
          <CalcStep label={t('std_ec2rc_uld_eff_creep')}
            formula={`\\varphi_{ef} = \\varphi(\\infty,t_0) \\cdot \\dfrac{M_{0Eqp}}{M_{0Ed}}`} />
          <CalcStep label=""
            formula={`= ${n(phi_inf_used,2)} \\times \\dfrac{${n(inp.M0Eqp??Math.round(Math.abs(MEd)*0.6),1)}}{${n(inp.M0EdRef==='2'?(inp.M2??MEd):(inp.M1??MEd),1)}} = ${n(phi_ef_calc,3)}${inp.phi_ef!=null ? ` \\ (\\text{${t('std_ec2rc_uld_overridden_to')} } ${n(phi_ef_used,3)})` : ''}`}
            result={<Tex>{`\\varphi_{ef} = ${n(phi_ef_used,3)}`}</Tex>} />
          <CalcStep label={t('std_ec2rc_uld_k1')}
          ...
          {slender && <>
            <CalcStep label={t('std_ec2rc_uld_curvature_8833')}
            ...
            <CalcStep label={t('std_ec2rc_uld_second_ecc')}
            ...
            <CalcStep label={t('std_ec2rc_uld_second_moment_label')}
      ...
      {(inp.firstOrder || inp.secondOrder) && (
        <DetailGroup title={t('std_ec2rc_uld_total_design_moment')}>
          <CalcStep label={t('std_ec2rc_uld_total_design_moment')}
