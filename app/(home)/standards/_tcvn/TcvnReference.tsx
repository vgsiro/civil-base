...
import { TCVN_PARTS, TCVN_CONCRETE, TCVN_REBAR, TCVN_LOAD_FACTORS } from '../_lib/tcvn-data'
import PageDiscussion from '../../../_components/home/discussion/PageDiscussion'

export default function TcvnReference({ section, pageKey, onNavChange }: { section: string; pageKey?: string; onNavChange: (key: string, val: string) => void }) {
