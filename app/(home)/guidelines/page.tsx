...
const sections = [
  {
    ...
    title: '1. Our Mission',
    content: `CivilAxis is a professional community built exclusively for civil engineers, structural engineers, geotechnical engineers, and related construction professionals. Our mission is to foster a high-quality, respectful, and educational environment where engineers can share knowledge, discuss technical problems, and grow together as a profession.

By using CivilAxis, you agree to uphold the standards of this community and contribute positively to the collective knowledge of our field.`,
  },
  {
...
• Career advice, professional development, and industry insights relevant to civil engineering`,
  },
  {
    ...
    content: `The following content is strictly prohibited on CivilAxis:
...
Posts flagged as sensitive may receive a warning even if not explicitly prohibited. When in doubt, include appropriate disclaimers.`,
  },
  {
    ...
    content: `CivilAxis is a professional space. We expect all members to:
...
Remember that your posts reflect on you as a professional. Conduct yourself as you would at a conference or peer review.`,
  },
  {
    ...
    content: `CivilAxis uses a transparent 3-strike warning system to enforce these guidelines:
...
Strike 3 — Account ban: Three warnings result in a permanent ban from CivilAxis. Banned accounts cannot post, comment, or interact with the community.
...
You can appeal a warning or ban by contacting our moderation team at the address below.`,
  },
  {
    ...
    content: `By posting on CivilAxis, you grant us a non-exclusive licence to display and distribute your content within the platform. You retain ownership of your original content.
...
CivilAxis respects your privacy. We do not sell your personal data to third parties. Please review our Privacy Policy for full details on how we collect and use your information.`,
  },
  {
    icon: <BookOpen size={20} color="#059669" />,
    title: '8. Quality Standards',
    content: `To maintain CivilAxis as a high-quality technical resource:
...
Low-quality, vague, or repetitive posts may be removed without warning.`,
  },
  {
    ...
    content: `CivilAxis offers a verification badge for licensed and practising professionals. Verification:
...
We are committed to fair and transparent moderation. Our goal is not to restrict conversation but to ensure CivilAxis remains a trusted, professional space for the engineering community.

CivilAxis reserves the right to update these guidelines at any time. Continued use of the platform constitutes acceptance of the current guidelines.`,
  },
]

export default function GuidelinesPage() {
  useEffect(() => { document.title = 'Guidelines — CivilAxis' }, [])
  return (
    <div style={{ minHeight: '100vh', background: '#f0f2f5', display: 'flex', flexDirection: 'column' }}>

      {/* Top bar */}
      <div style={{ background: '#fff', borderBottom: '1px solid #e4e6eb', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', position: 'sticky', top: 0, zIndex: 100 }}>
        <HomeNavBar pageLabel="Guidelines">
          <span style={{ fontSize: 15, fontWeight: 600, color: '#65676b' }}>Community Guidelines</span>
        </HomeNavBar>
      </div>

      <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 20px 48px', flex: 1, width: '100%', boxSizing: 'border-box' as const }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #2563eb 60%, #7c3aed 100%)', borderRadius: 16, padding: '40px 40px 36px', marginBottom: 32, color: '#fff' }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.7, color: 'rgba(255,255,255,0.88)', margin: 0 }}>
            CivilAxis is a professional knowledge-sharing platform for civil engineers. These guidelines exist to protect the quality, safety, and integrity of our community. By using CivilAxis, you agree to abide by the standards described below.
          </p>
        </div>
