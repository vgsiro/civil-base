...
import type { SteelGrade, CrossSectionResult, LtbRow, MNrdRow, NbRdRow } from './ec3-engine'
...
export function ColdFormedExportModal({
  row, grade, cs, ltbRows, mnRows, nbRows,
  ...
  const groups: SectionGroup[] = [
    {
      color: '#1d4ed8',
      label: t('bbcf_exp_bend_label'),
      desc: t('bbcf_exp_bend_desc'),
      detDesc: t('bbcf_exp_bend_detdesc'),
      refs: [bendRef, bendDetRef],
      defaultOn: true,
    },
    {
      color: '#0d9488',
      label: t('bbcf_exp_axbend_label'),
      desc: t('bbcf_exp_axbend_desc'),
      detDesc: t('bbcf_exp_axbend_detdesc'),
      refs: [axRef, axDetRef],
      defaultOn: true,
    },
    {
      color: '#b45309',
      label: t('bbcf_exp_comp_label'),
      desc: t('bbcf_exp_comp_desc'),
      detDesc: t('bbcf_exp_comp_detdesc'),
  ...
  return (
    <ExportModal
      title={t('bbcf_exp_title')}
      defaultReport={t('bbcf_exp_default_report')}
      groups={groups}
      onClose={onClose}
    >
      {() => (
        <>
          <div ref={bendRef} style={{ fontFamily: "'Segoe UI',Arial,sans-serif", fontSize: 11 }}>
            ...
            <BendingSection
              row={row} grade={grade} ltbRows={ltbRows} cs={cs}
          ...
          <div ref={axRef} style={{ fontFamily: "'Segoe UI',Arial,sans-serif", fontSize: 11 }}>
            <AxialBendingSection
              row={row} grade={grade} mnRows={mnRows} cs={cs}
          ...
          <div ref={compRef} style={{ fontFamily: "'Segoe UI',Arial,sans-serif", fontSize: 11 }}>
            <CompressionSection
              row={row} grade={grade} nbRows={nbRows} cs={cs}
