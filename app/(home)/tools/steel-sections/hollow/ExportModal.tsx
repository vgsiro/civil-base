...
export function HollowExportModal({
  ...
  const groups: SectionGroup[] = [
    {
      color: '#1d4ed8',
      label: t('bbhs_exp_bend_label'),
      desc: t('bbhs_exp_bend_desc'),
      detDesc: t('bbhs_exp_bend_detdesc'),
      refs: [bendRef, bendDetRef],
      defaultOn: true,
    },
    {
      color: '#0d9488',
      label: t('bbhs_exp_axbend_label'),
      desc: t('bbhs_exp_axbend_desc'),
      detDesc: t('bbhs_exp_axbend_detdesc'),
      refs: [axRef, axDetRef],
      defaultOn: true,
    },
    {
      color: '#b45309',
      label: t('bbhs_exp_comp_label'),
      desc: t('bbhs_exp_comp_desc'),
      detDesc: t('bbhs_exp_comp_detdesc'),
  ...
  return (
    <ExportModal
      title={t('bbhs_exp_title')}
      defaultReport={t('bbhs_exp_default_report')}
      groups={groups}
      onClose={onClose}
    >
      {() => (
