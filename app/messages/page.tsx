...
export default function MessagesPage() {
  ...
  async function loadConversations() {
    ...
    // Filter to only convs where current user is a participant
      ...
      <div style={{ flex: 1, maxWidth: 1060, width: '100%', margin: '16px auto', display: 'grid', gridTemplateColumns: '360px 1fr', gap: 0, background: '#fff', borderRadius: 12, border: '1px solid #e4e6eb', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', overflow: 'hidden', height: 'calc(100vh - 88px)' }}>
        ...
        {activeConvId && peerProfile ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, color: '#94a3b8', padding: 40 }}>
            ...
            <div style={{ fontSize: 14, color: '#65676b', textAlign: 'center' as const, maxWidth: 260 }}>Send private messages to engineers in the Civil Base community.</div>
            <button onClick={() => setShowNewMsg(true)}
