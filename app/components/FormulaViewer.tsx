...
export default function FormulaViewer({ html }: Props) {
  ...
  useEffect(() => {
    ...
    import('katex').then(({ default: katex }) => {
      ...
      // Convert legacy block JSON to HTML
      let rendered = html
      ...
      // Strip data-* attrs that break structure
      rendered = rendered.replace(/ data-[a-z-]+=["'][^"']*["']/g, '')

      // Strip previously-rendered KaTeX spans back to $tex$ source
      ...
      // Re-render $...$ and $$...$$ with current katex
